...
for ticker_nm in kor_ticker_list['ticker']:
    ...
    # Google Storage 적재
    source_file_name = f'data_crawler/dashboard/gemini_result_kospi_{today_date1}.csv'    # GCP에 업로드할 파일 절대경로
    destination_blob_name = f'data_crawler/dashboard/gemini_result_kospi_{today_date1}.csv'    # 업로드할 파일을 GCP에 저장할 때의 이름
