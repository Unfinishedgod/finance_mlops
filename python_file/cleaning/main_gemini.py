...
os.system(f"nohup {python_dir} {file_dir}/cleaning/gemini_kosdaq.py {str(4)} >> gemini_kosdaq.txt &")

os.system(f"/home/shjj08choi4/anaconda3/bin/python3 {file_dir}/send_gmail.py 'gemini_코스피코스닥'")
