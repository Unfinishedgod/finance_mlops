...
for market_nm in market_list:
    ...
    total_df_date = total_df_date.reset_index()    

    ### 
    table_from_pandas = pa.Table.from_pandas(total_df_date,preserve_index = False)
    pq.write_table(table_from_pandas, f'data_crawler/kor_stock_{market_nm}_trading.parquet')
